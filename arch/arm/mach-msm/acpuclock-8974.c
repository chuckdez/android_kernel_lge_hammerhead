...
static struct msm_bus_paths bw_level_tbl_v1[] __initdata = {
	...
	[1] = BW_MBPS(8000), /* At least 1000 MHz on bus. */
};

static struct l2_level l2_freq_tbl_v1[] __initdata = {
	[0]  = { {  300000, PLL_0, 0,   0 }, LVL_LOW,   950000, 0 },
	[1]  = { {  652800, HFPLL, 1,  34 }, LVL_NOM,   950000, 0 },
	[2] = { { 1497600, HFPLL, 1,  78 }, LVL_HIGH, 1050000, 1 },
	{ }
};

static struct acpu_level acpu_freq_tbl_v1_pvs0[] __initdata = {
	{ 1, {  300000, PLL_0, 0,   0 }, L2(0),   825000,  73 },
	{ 1, {  652800, HFPLL, 1,  34 }, L2(0),   825000, 165 },
	{ 0, { 1497600, HFPLL, 1,  78 }, L2(1),  995000, 423 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(1), 1050000, 506 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_v1_pvs2[] __initdata = {
	{ 1, {  300000, PLL_0, 0,   0 }, L2(0),   825000,  73 },
	{ 1, {  652800, HFPLL, 1,  34 }, L2(0),   825000, 165 },
	{ 0, { 1497600, HFPLL, 1,  78 }, L2(1),  960000, 423 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(1), 1000000, 506 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_v1_pvs4[] __initdata = {
	{ 1, {  300000, PLL_0, 0,   0 }, L2(0),  825000,  73 },
	{ 1, {  652800, HFPLL, 1,  34 }, L2(0),  825000, 165 },
	{ 0, { 1497600, HFPLL, 1,  78 }, L2(1), 910000, 423 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(1), 950000, 506 },
	{ 0, { 0 } }
};
...
static struct l2_level l2_freq_tbl_v2[] __initdata = {
	...
	[1]  = { {  652800, HFPLL, 1,  34 }, LVL_NOM,   950000, 0 },
	[2] = { { 1497600, HFPLL, 1,  78 }, LVL_HIGH, 1050000, 1 },
	[3] = { { 1728000, HFPLL, 1,  90 }, LVL_HIGH, 1050000, 1 },
	{ }
};

static struct acpu_level acpu_freq_tbl_2g_pvs0[] __initdata = {
	{ 1, {  300000, PLL_0, 0,   0 },  L2(0),  815000,  73 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(0),  865000, 165 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(1), 1010000, 423 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(1), 1100000, 598 },
	{ 0, { 0 } }
};

static struct acpu_level acpu_freq_tbl_2g_pvs1[] __initdata = {
	{ 1, {  300000, PLL_0, 0,   0 },  L2(0),  800000,  73 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(0),  850000, 165 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(1),  990000, 423 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(1), 1075000, 598 },
	{ 0, { 0 } }
};

static struct acpu_level acpu_freq_tbl_2g_pvs2[] __initdata = {
	{ 1, {  300000, PLL_0, 0,   0 },  L2(0),  785000,  73 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(0),  835000, 165 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(1),  970000, 423 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(1), 1050000, 598 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2g_pvs4[] __initdata = {
	{ 1, {  300000, PLL_0, 0,   0 },  L2(0),  775000,  73 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(0),  810000, 165 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(1),  930000, 423 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(1), 1000000, 598 },
	{ 0, { 0 } }
};

static struct acpu_level acpu_freq_tbl_2g_pvs5[] __initdata = {
	{ 1, {  300000, PLL_0, 0,   0 },  L2(0),  750000,  73 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(0),  800000, 165 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(1),  910000, 423 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(1),  975000, 598 },
	{ 0, { 0 } }
};

static struct acpu_level acpu_freq_tbl_2g_pvs6[] __initdata = {
	{ 1, {  300000, PLL_0, 0,   0 },  L2(0),  750000,  73 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(0),  790000, 165 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(1),  895000, 423 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(1),  950000, 598 },
	{ 0, { 0 } }
};

static struct acpu_level acpu_freq_tbl_2p2g_pvs0[] __initdata = {
	{ 1, {  300000, PLL_0, 0,   0 },  L2(0),  800000,  72 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(0),  835000, 161 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(1),  965000, 409 },
	{ 1, { 2150400, HFPLL, 1, 112 }, L2(1), 1100000, 656 },
	{ 0, { 0 } }
};

static struct acpu_level acpu_freq_tbl_2p2g_pvs1[] __initdata = {
	{ 1, {  300000, PLL_0, 0,   0 },  L2(0),  800000,  72 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(0),  820000, 161 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(1),  945000, 409 },
	{ 1, { 2150400, HFPLL, 1, 112 }, L2(1), 1075000, 656 },
	{ 0, { 0 } }
};

static struct acpu_level acpu_freq_tbl_2p2g_pvs2[] __initdata = {
	{ 1, {  300000, PLL_0, 0,   0 },  L2(0),  775000,  72 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(0),  805000, 161 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(1),  925000, 409 },
	{ 1, { 2150400, HFPLL, 1, 112 }, L2(1), 1050000, 656 },
	{ 0, { 0 } }
};

static struct acpu_level acpu_freq_tbl_2p2g_pvs3[] __initdata = {
	{ 1, {  300000, PLL_0, 0,   0 },  L2(0),  775000,  72 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(0),  790000, 161 },
	{ 1, { 1036800, HFPLL, 1,  54 }, L2(1),  840000, 267 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(1),  910000, 409 },
	{ 1, { 2150400, HFPLL, 1, 112 }, L2(1), 1025000, 656 },
	{ 0, { 0 } }
};

static struct acpu_level acpu_freq_tbl_2p2g_pvs4[] __initdata = {
	{ 1, {  300000, PLL_0, 0,   0 },  L2(0),  775000,  72 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(0),  780000, 161 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(1),  895000, 409 },
	{ 1, { 2150400, HFPLL, 1, 112 }, L2(1), 1000000, 656 },
	{ 0, { 0 } }
};

static struct acpu_level acpu_freq_tbl_2p2g_pvs5[] __initdata = {
	{ 1, {  300000, PLL_0, 0,   0 },  L2(0),  750000,  72 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(0),  770000, 161 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(1),  880000, 409 },
	{ 1, { 2150400, HFPLL, 1, 112 }, L2(1),  975000, 656 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p2g_pvs6[] __initdata = {
	...
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(1),  870000, 409 },
	{ 1, { 2150400, HFPLL, 1, 112 }, L2(1),  950000, 656 },
	{ 0, { 0 } }
};

static struct acpu_level acpu_freq_tbl_2p3g_pvs0[] __initdata = {
	{ 1, {  300000, PLL_0, 0,   0 },  L2(0),  800000,  72 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(0),  825000, 159 },
	{ 1, { 1574400, HFPLL, 1,  82 }, L2(1),  965000, 430 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(1), 1100000, 691 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs1[] __initdata = {
	...
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(1),  930000, 404 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(1), 1075000, 691 },
	{ 0, { 0 } }
};

static struct acpu_level acpu_freq_tbl_2p3g_pvs2[] __initdata = {
	{ 1, {  300000, PLL_0, 0,   0 },  L2(0),  775000,  72 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(0),  795000, 159 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(1),  910000, 404 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(1), 1050000, 691 },
	{ 0, { 0 } }
};

static struct acpu_level acpu_freq_tbl_2p3g_pvs3[] __initdata = {
	{ 1, {  300000, PLL_0, 0,   0 },  L2(0),  775000,  72 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(0),  780000, 159 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(1),  895000, 404 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(1), 1025000, 691 },
	{ 0, { 0 } }
};

static struct acpu_level acpu_freq_tbl_2p3g_pvs4[] __initdata = {
	{ 1, {  300000, PLL_0, 0,   0 },  L2(0),  775000,  72 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(0),  775000, 159 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(1),  880000, 404 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(1), 1000000, 691 },
	{ 0, { 0 } }
};

static struct acpu_level acpu_freq_tbl_2p3g_pvs5[] __initdata = {
	{ 1, {  300000, PLL_0, 0,   0 },  L2(0),  750000,  72 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(0),  760000, 159 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(1),  870000, 404 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(1),  975000, 691 },
	{ 0, { 0 } }
};

static struct acpu_level acpu_freq_tbl_2p3g_pvs6[] __initdata = {
	{ 1, {  300000, PLL_0, 0,   0 },  L2(0),  750000,  72 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(0),  750000, 159 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(1),  860000, 404 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(1),  950000, 691 },
	{ 0, { 0 } }
};
